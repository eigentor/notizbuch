<?php
/* the old code moved to html.tpl.php */
?>
<div id="page">
  <div id="masthead">
    <div id="header" class="clearfix">
      ...
      <?php endif; ?>
          <div id="logo-title">
            <?php $logo_path = base_path() . path_to_theme() . '/images/' . theme_get_setting('litejazz_style') ?> 
            <?php if ($logo): ?>
              <?php if (theme_get_setting('litejazz_themelogo')) { ?>
                <a href="<?php print $base_path; ?>" title="<?php print t('Home'); ?>"> 
                <img src="<?php print $logo_path . '/logo.png'; ?>" alt="<?php print t('Home'); ?>" id="logo" /> 
                </a>
              <?php } else { ?>
                <a href="<?php print $base_path; ?>" title="<?php print t('Home'); ?>"> 
  ...
  <div id="footer"> 
    ...
    <div id="footer-message">
      ...
      <a href="http://www.roopletheme.com" title="RoopleTheme!" target="_blank">
        <img src="<?php print $logo_path . "/roopletheme.png"; ?>" alt="RoopleTheme!"/>
      </a> 
      <?php } else { ?>
      <a href="http://www.roopletheme.com" title="RoopleTheme!" target="_blank">
